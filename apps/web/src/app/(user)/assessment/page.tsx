...
export default function AssessmentPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 py-6">
              ...
              <div key={i} className="flex flex-col items-center flex-1 relative group">
                ...
                <div className="mt-4 text-center">
                  ...
                  <span className={cn(
                    ...
                    isCurrent ? "text-white" : "text-muted-foreground/60"
                  )}>
                    {s.title}
                  </span>
                </div>
      ...
      <div className="glass rounded-[2.5rem] border border-white/10 shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-500">
