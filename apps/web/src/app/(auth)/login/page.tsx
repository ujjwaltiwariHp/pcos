...
export default function LoginPage() {
  return (
    <div className="w-full max-w-[480px] mx-auto animate-in fade-in zoom-in-95 duration-1000 ease-out px-4 py-10 md:py-20 relative z-10">
      <div className="glass rounded-[3rem] p-8 md:p-12 border border-border/50 relative overflow-hidden group">
        <div className="absolute top-0 right-0 w-32 h-32 bg-primary/5 blur-3xl rounded-full -mr-16 -mt-16 pointer-events-none" />
        
        <CardHeader className="p-0 mb-10 space-y-3 text-center">
          <CardTitle className="text-3xl md:text-4xl font-black tracking-tight text-foreground">Welcome Back</CardTitle>
        ...
        <CardContent className="p-0">
          <Tabs defaultValue="login" className="w-full">
            <TabsList className="flex w-full p-1.5 bg-muted/30 rounded-[1.5rem] mb-10 border border-border/50 backdrop-blur-xl">
              <TabsTrigger 
                value="login" 
                ...
                data-[state=inactive]:hover:bg-muted/50 data-[state=inactive]:text-muted-foreground/60"
              >
                Sign In
              </TabsTrigger>
              <TabsTrigger 
